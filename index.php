...
<body>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p>On the <b>right</b> side of the screen, when a video is selected, you find a video player with a rating bar and a rating scale to be used. The video will autoplay after a <b> 5 seconds countdown</b>. Moving your cursor along the ratings bar located under the video changes the recorded rating value for the selected emotional dimension (valence/arousal/dominance). The dimensions rate the videos continuously, with each end representing the maximum value. </p>
            <p> Arousal, on the left is “very passive”, the right is “very active”; valence, the left is “very negative” and the right is “very positive”; and dominance, the left is “in control” and the right is “uncontrolled”.<p>
            <p><b>Please note</b>
            <ul>
            ...
            <p>After rating the video please select the <b> primary behavior </b> that influenced your rating in the text box provided.</p>
            <br> 
            <p>For questions, information and details please contact sakiri1@umbc.edu.</p>
          </div>
    ...
    $("#behavior").submit(function(e) {

        e.preventDefault(); // avoid to execute the actual submit of the form.

        $("#submit-behavior").attr("disabled", true);
        $('#saving').fadeIn();
        ...
        $.ajax({
            ...
            error: function (xhr, ajaxOptions, thrownError) {
                $("#submit-behavior").attr("disabled", false);
                $('#saving').fadeOut(function() {$('#error-alert').fadeIn()});
                console.log(xhr.responseText);
            }
        });
