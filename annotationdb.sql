...
--
-- Struttura della tabella `behavior`
--

CREATE TABLE `behavior` (
  `User` int(11) NOT NULL,
  `NameVideo` text NOT NULL,
  `AnnoType` text NOT NULL,c
  `ClenchedFist` boolean NOT NULL DEFAULT 0,
  `ArmsCrossing` boolean NOT NULL DEFAULT 0,
  `LegsOpen` boolean NOT NULL DEFAULT 0,
  `HandsOnWaist` boolean NOT NULL DEFAULT 0,
...
--
-- Indici per le tabelle `behavior`
--
...
--
-- AUTO_INCREMENT per la tabella `behavior`
--
ALTER TABLE `behavior`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
